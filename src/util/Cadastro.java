...
public class Cadastro {
	...
	public static Orientador CadastrarOrientador(Scanner s) {
		...
		return new Orientador(nome, idade, email, senha, id_institucional, titulacao, areaAtuacao, limiteOrientados,
				siape, institutoVinculado);
	...
	public static Gestor CadastrarGestor(Scanner s) {
		...
		return new Gestor(nome, idade, email, senha, id_institucional, titulacao, areaAtuacao, limiteOrientados, siape,
				institutoVinculado);
	...
	public static Relatorio CadastrarRelatorio(Scanner s) {
		...
		return new Relatorio(titulo, conteudo, dataGeracao, criador, false);
	}
}
