...
public class Gestor extends Orientador {
	...
	public Gestor(String nome, int idade, String email, String senha, String idInstitucional, String titulacao,
			String areaAtuacao, int limiteOrientados, String siape, String institutoVinculado) {

		super(nome, idade, email, senha, idInstitucional, titulacao, areaAtuacao, limiteOrientados, siape,
				institutoVinculado);
	}
